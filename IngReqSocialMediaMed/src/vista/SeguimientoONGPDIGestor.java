...
public class SeguimientoONGPDIGestor extends JPanel {
	...
	private void ponerModoSeguimiento() {
		...
		JComboBox<Valoracion> valoracionONG = new JComboBox<Valoracion>();
		...
		JTextArea comentarioPDI = new JTextArea();
		...
		if(consultado.getNumHoras() >= 0) {
			numHoras.setText(Double.toString(consultado.getNumHoras()));
		}
